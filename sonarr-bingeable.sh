...
echo "======================================================================================"
echo "  This script has created a log file at: $LOG_FILE"
echo "  To view the log file, use the following command:"
echo ""
echo "  cat $LOG_FILE"
echo ""
echo "  To follow the log in real-time during script execution, use:"
echo "  tail -f $LOG_FILE"
echo ""
echo "  NOTE FOR UNRAID USERS: The log is stored in /var which is on the RAM disk."
echo "  This means logs will be lost after a system reboot."
echo "  For persistent logging, consider changing LOG_FILE to a location on your array,"
echo "  such as /mnt/user/appdata/sonarr_move_complete.log"
echo "======================================================================================"
